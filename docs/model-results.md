...
`python -m src.stage3.report` 출력. 끝난 모델·창 10개: dtree_30s, dtree_60s, gboost_30s, gboost_60s, logreg_30s, logreg_60s, rf_30s, rf_60s, rule_30s, rule_60s.
설계는 [model-comparison-design.md](./model-comparison-design.md), 근거 문헌은 [stage3-literature.md](./stage3-literature.md).
