// 고개 떨굼 규칙. 설계 docs/imu-rule-design.md, 파이썬 기준 모델 src/imu_ref.py (비트 단위 일치).
//
// 입력은 준용 블록의 가속도 3축(16비트 signed, ±2 g = 16,384 LSB/g)과 갱신 펄스 i_imu_valid(100 Hz).
...
// 축 번호·부호는 준용 v13 11절(도면 도출). 실물 장착 확인 뒤 파라미터만 바꾼다.
